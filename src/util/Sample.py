...
if __name__ == "__main__":   
   ...
   # print ret
   sVerifyMsgSig="77c1cc92b950bf6f3a57163be4d1f6b0f769a78c"
   #sVerifyTimeStamp=HttpUtils.ParseUrl("timestamp")
   sVerifyTimeStamp="1507721727"
   #sVerifyNonce=HttpUitls.ParseUrl("nonce")
   sVerifyNonce="1028473044"
   #sVerifyEchoStr=HttpUtils.ParseUrl("echostr")
   sVerifyEchoStr="tBnQ6vNbWB%2FiZXBoNLqUeQ0LVg8pKUqJI%2FpIZSnvtf72ZSyvFcrqbUmaaiLd2m5x%2BnxCLlDuiYeCE7O8DDZ0Cg%3D%3D"
